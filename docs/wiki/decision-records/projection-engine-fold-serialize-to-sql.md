# ADR: Projection = engine-fold + serialize-to-SQL
...
wiki/DESIGN.md §16.1); that export is part of the coordinated engine changes.
...
keeping workspaces hydratable anyway (§9).
